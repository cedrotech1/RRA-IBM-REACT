            ...
            <div className="col-12 hero-text-image">
                  ...
                  <form onSubmit={handleSubmit} className="php-email-form">
                    <div className="row">
                      ...
                      <div className="col-md-6 form-group">
                        ...
                        <input type="text" name="tinnumber" className="form-control" id="tinnumber" onChange={handleChange} required />
                      </div>
                      <div className="col-md-6 form-group">
                        <label htmlFor="nid">National Identification number (NID)</label>
                        <input type="text" name="nid" className="form-control" id="nid" onChange={handleChange} required />
                      </div>
                      <div className="col-md-6 form-group">
                      ...
                      <div className="col-md-12 form-group">
                        ...
                        <textarea className="form-control" name="businessDescription" id="businessDescription" onChange={handleChange} required />
                      </div>
                    </div>
                    <br />
                    <div className='row'>
              ...
              {loading ? 'loading...': 'Create account'}
                ...
                <div class="col-lg-4 iphone-wrap p-10">
                  <img src="assets/img/RRA Logo.png" alt="Image" class="phone-1" data-aos="fade-right" style={{ width: '13cm', marginTop: '12cm' }} />
