...
function App() {
  return (
   ...
   <Hero title='WELCAME  MR CEDRICK TO RRA CLAIMNG PAGE' discription='welcame to rwanda revenue autority claiming page !'  Button_1_link='claim' Button_1_Name='Claim now' Button_2_link='myclaim' Button_2_Name='My claims'/>
